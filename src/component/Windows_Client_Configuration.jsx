import '../styles/Windows_Client_Configuration.css'
...
const Windows_Client_Configuration = () => {
    ...
    return (
        <div className="service">
            ...
            <div className='lorem1'>
                <div className="servHead1">
                    <h1>Windows Client Configuration</h1>
                </div>
                <div className="mainHed1">
                    ...
                    <div className="nowDesn">
                        <h4>Windows Client Configuration</h4>
                    </div>
            ...
            <div className="Arrangement1">
                ...
                <div className="FullGurd1">
                    ...
                    <div className="btn-get">
                        <button id='btnsNew4z'>GET IT NOW</button>
                    </div>
                </div>
            </div>
            ...
            <div className='whatIs1'>
                <h1
                    className={`accordion1 ${activeIndex.includes(0) ? 'active' : ''}`}
                ...
                <div className={`panel ${activeIndex.includes(0) ? 'show' : ''}`}>
                    ...
                    <p className='pink-box-txt'>Eg: htts://vpn.yourcompany.com:7443/</p>
                    <img id='step1' src={login} alt="" />
                </div>

                <h1
                    className={`accordion1 ${activeIndex.includes(1) ? 'active' : ''}`}
                    onClick={() => handleAccordionClick(1)}
                >
                    <AiOutlinePlus className='plus2' /> Step 2
                </h1>
                <div className={`panel ${activeIndex.includes(1) ? 'show' : ''}`}>
                    <p id='userDet2'>Once logged in, Download the Client package by clicking on WINDOWS CLIENT link.</p>
                    <p className='pink-box-txt'>Alternatively, You can download from this link</p>
                    <img id='wstep2' src={Package} alt="" />
                </div>

                <h1
                    className={`accordion1 ${activeIndex.includes(2) ? 'active' : ''}`}
                    onClick={() => handleAccordionClick(2)}
                >
                    <AiOutlinePlus className='plus3' /> Step 3
                </h1>
                <div className={`panel ${activeIndex.includes(2) ? 'show' : ''}`}>
                    <p id='userDet3'>Once downloaded, extract the package and install the&nbsp;<span id='sslVpn'>SecurePoint SSL VPN exe</span> on your system.</p>
                    <p className='pink-box-txt'>Select the&nbsp;<span id='ovpn'>NixVPN.ovpn</span>&nbsp;file and click on import.</p>
                </div>

                <h1
                    className={`accordion1 ${activeIndex.includes(3) ? 'active' : ''}`}
                    onClick={() => handleAccordionClick(3)}
                >
                    <AiOutlinePlus className='plus4' /> Step 4
                </h1>
                <div className={`panel ${activeIndex.includes(3) ? 'show' : ''}`}>
                    <p id='install'>Once installed, Start the&nbsp;<span id='Spoint'>Securepoint SSL VPN</span>&nbsp;software from the desktop.</p>
                    {/* <p id='ubuntu'>Eg: on ubuntu,</p>
        <p id='pink'>sudo apt-get install network-manager-openvpn-gnome network-manager-vpnc-gnome</p> */}
                </div>

                <h1
                    className={`accordion1 ${activeIndex.includes(4) ? 'active' : ''}`}
                ...
                <div className={`panel ${activeIndex.includes(4) ? 'show' : ''}`}>
                    ...
                    <li id='Connections2'>Click on the<span id='fontSize2'>Gear</span>&nbsp; Button , and select on <span id='fontSize3'>Import, </span>&nbsp;the below window will be opened.</li>
        ...
        <img id='vpnImage' src={VPN} alt="" /> */}
                ...
                <h1
                    className={`accordion1 ${activeIndex.includes(5) ? 'active' : ''}`}
                ...
                <div className={`panel ${activeIndex.includes(5) ? 'show' : ''}`}>
                    ...
                    <img id='imgSec' src={secure} alt="" />
                </div>

                <h1
                    className={`accordion1 ${activeIndex.includes(6) ? 'active' : ''}`}
                    onClick={() => handleAccordionClick(6)}
                >
                    <AiOutlinePlus className='plus4' /> Step 7
                </h1>
                <div className={`panel ${activeIndex.includes(6) ? 'show' : ''}`}>
                    <p id='window'>Now Click on the &nbsp;<span id='Uname'>2 Bold Arrows</span>&nbsp;to get connected.</p>
                    <img id='imgPoint' src={point} alt="" />
                </div>
      ...
      <div className={`panel ${activeIndex === 7 ? "show" : ""}`}>
        ...
        <img id='ConfigureVPN' src={ConfigureVPN} alt="" />
                ...
                <div className='connect-text'>
                    <h1 id='headCard1'>That’s it, Now you are connected to your NixVPN server.</h1>
                </div>
            ...
            <div className="Teamz1">

                <div className="supportz1">
            ...
            <div className="home1z1">
                <div className="work1z1">
                    <h1>Pricing Plan</h1>
                </div>
                ...
                <div className="connect1z1">
                    <div className="easy1z1">
                        ...
                        <h6 className='card-sub-header'>Save 42%</h6>
                        <h6 className='card-sub-header'> $83.88</h6>
                        <p>build payment every years</p>
                        <button id='btnsNew1z'>GET IT NOW</button>
                    </div>

                    <div className="instant1z1">
                        <h5>Yearly</h5>
...
export default Windows_Client_Configuration;