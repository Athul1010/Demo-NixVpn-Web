import '../styles/Linux_Client_Configuration.css'
...
const Linux_Client_Configuration = () => {
        ...
        <div className="service">
            ...
            <div className='lorem'>
                <div className="servHead">
                    <h1>Linux Client Configuration</h1>
                </div>
                <div className="mainHed">
                    ...
                    <div className="nowDesn">
                        <h4>Linux Client Configuration</h4>
                    </div>
            ...
            <div className='whatIs'>
                ...
                <div className={`panel ${activeIndex.includes(0) ? 'show' : ''}`}>
                    <p id='userDet1'>Login to the user portal provided by your System Administrator. Eg: htts://vpn.yourcompany.com:7443</p>
                ...
                <div className={`panel ${activeIndex.includes(1) ? 'show' : ''}`}>
                    <p id='userDet2'>Once logged in, Download the Client package by clicking on LINUX CLIENT link.</p>
                ...
                <div className={`panel ${activeIndex.includes(2) ? 'show' : ''}`}>
                    <p id='userDet3'>Once downloaded, extract the package and note the NixVPN.ovpn file location.</p>
                </div>
                ...
                <div className={`panel ${activeIndex.includes(3) ? 'show' : ''}`}>
                    <p id='install'>Install the client packages with your package manager.</p>
                ...
                <div className={`panel ${activeIndex.includes(4) ? 'show' : ''}`}>
                    ...
                    <li id='Connections2'>Click <span id='fontSize2'>ADD</span>&nbsp;and choose <span id='fontSize3'>Import a Saved VPN configuration</span>&nbsp;from the menu</li>
                ...
                <div className={`panel ${activeIndex.includes(6) ? 'show' : ''}`}>
                    <p id='window'>Fill your&nbsp;<span id='Uname'>Username</span>&nbsp;and&nbsp;<span id='Pname'>password</span>&nbsp;on the import window, and click save.</p>
                </div>

                <h1
                    className={`accordion ${activeIndex.includes(7) ? 'active' : ''}`}
                    onClick={() => handleAccordionClick(7)}
                >
                    <AiOutlinePlus className='plus4' /> Step 8
                </h1>
                <div className={`panel ${activeIndex.includes(7) ? 'show' : ''}`}>
            ...
            <div className="home1z">
                ...
                <div className="connect1z">
                    ...
                    <div className="instant1z">
                        ...
                        <h6 className='card-sub'>Save 42%</h6>
                        <div className="horizontal-line"></div>
                        <h6 className='card-sub'> $143.65</h6>
                        <p>build payment every years</p>
                    ...
                    <div className="enjoy1z">
                        ...
                        <h6 className='card-sub'>Save 42%</h6>
                        <h6 className='card-sub'>$214.69</h6>
                        <p>build payment every years</p>
...
export default Linux_Client_Configuration;